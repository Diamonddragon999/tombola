...
export default function JoinFormUI() {
  ...
  if (state !== 'idle')
    return (
      <Card className="min-h-screen w-full bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 backdrop-blur-sm border border-white/20 p-6 flex items-center justify-center">
        <CardHeader>
  ...
  return (
    <Card className="min-h-screen w-full bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 backdrop-blur-sm border border-white/20 p-6">
