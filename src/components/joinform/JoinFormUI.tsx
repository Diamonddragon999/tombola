    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 p-4">
      <Card className="w-full max-w-lg bg-white/10 backdrop-blur-sm border-white/20">
        <CardHeader className="text-center">
          <img src="https://rovision.ro/wp-content/themes/storefront-child/rovision-logo.svg"
               alt="logo" className="h-12 mx-auto mb-4" />
          ...
          <form onSubmit={(e)=>{e.preventDefault(); void submit();}} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input id="fn" value={data.firstName}
              ...
              <div>
                ...
                <Input id="ln" value={data.lastName}
            ...
            <div>
              ...
              <Input id="em" type="email" value={data.email}
            ...
            <SocialCheck id="fb" tone="blue" checked={data.followsFacebook}
            ...
            <SocialCheck id="ig" tone="pink" checked={data.followsInstagram}
            ...
            <SocialCheck id="yt" tone="red" checked={data.followsYoutube}
            ...
            <div className="flex items-center space-x-2">
              <Checkbox id="nl" checked={data.newsletterConsent}
